...
public class AdminServlet extends HttpServlet {
	...
	public void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		String forwardPath="/jsp/admin/main/admin_page.jsp";
		...
		if (command == null || command.equals("manage_goods")) {
			...
			*/
			...
			response.sendRedirect("/Shoping11/admin/admin.do?command=add_goods_imagefile&goods_id="+goods_id);
			return;
			...
			*/
			...
			session.setAttribute("goodsVO",goodsVO );
			response.sendRedirect("/Shoping11/admin/admin.do?command=modify_goods_image_page&goods_id="+goods_id);
			return;
