...
<!-- 	<DIV>
	...
	<DIV id="search">
		<FORM>
			<INPUT name="input" class="main_input" type="text">
			<INPUT name="search" class="btn1" type="button" value="검색">
		</FORM>
	</DIV>
</DIV>
<br><br><br>
...
<!-- 	<DIV>
	...
	<DIV id="search">
		<FORM>
			<INPUT name="search" class="btn1" type="button" value="제품 정보 수정">
			<INPUT name="search" class="btn1" type="button" value="제품 정보 삭제">
			<INPUT name="search" class="btn1" type="button" value="제품 정보 등록">
		</FORM>
	</DIV> -->
</DIV>
<!-- DIV class="clear"></DIV>
