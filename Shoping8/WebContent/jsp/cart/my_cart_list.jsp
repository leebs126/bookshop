...
function order_goods(goods_id,goods_title,goods_sales_price,goods_fileName){
...
function fn_order_all_cart_goods(){
	...
	/*
	objForm.method="post";
	objForm.action="/Shoping8/order/order.do";
	objForm.submit();
	*/
}
...
<form name="frm_order_all_cart">
					...
					<td>
					      <a href="javascript:order_goods('${item.goods_id }','${item.goods_title }','${item.goods_sales_price}','${item.goods_fileName}');">
