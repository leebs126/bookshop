...
<c:choose>
	...
	<c:when test="${command=='mypage_list' }">
		<tiles:insertDefinition name="mine.mypage_list" />
	</c:when>
	<c:when test="${command=='order_all_cart_goods' }">
		<tiles:insertDefinition name="order.order_goods" />
	</c:when>
	<c:when test="${command=='order_result' }">
		<tiles:insertDefinition name="order.order_goods_result" />
	</c:when>
