...
public class GoodsVO {
	...
	private ArrayList list_detail_Image;
	...
	public int getGoods_page_total() {
		return goods_page_total;
	}



	public void setGoods_page_total(int goods_page_total) {
		this.goods_page_total = goods_page_total;
	}
	...
	public ArrayList getList_detail_Image() {
		return list_detail_Image;
	}



	public void setList_detail_Image(ArrayList list_detail_Image) {
		this.list_detail_Image = list_detail_Image;
	}
	...
	public String getPublisher_comment() {
		return publisher_comment;
	}



	public void setPublisher_comment(String publisher_comment) {
		this.publisher_comment = publisher_comment;
	}
