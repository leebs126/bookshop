...
function modify_cart_qty(goods_id,bookPrice){
	...
	$.ajax({
		...
		url : "http://localhost:8090/Shoping12/cart/cart.do",
		data : {
...
function order_each_goods(goods_id,goods_title,goods_sales_price,fileName){
...
function fn_order_all_cart_goods(){
	...
	if(length>1){
 	...
 	objForm.method="post";
	objForm.action="/Shoping12/order/order.do";
	objForm.submit();
}
...
<form name="frm_order_all_cart">
					...
					<td>
					      <a href="javascript:order_each_goods('${item.goods_id }','${item.goods_title }','${item.goods_sales_price}','${item.fileName}');">
