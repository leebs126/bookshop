...
<BODY>
<form  name="frm_mod_goods" action="<%=request.getContextPath() %>/admin/admin.do" method=post >
<DIV class="clear"></DIV>
	<!-- 내용 들어 가는 곳 -->
	<DIV id="container">
		<UL class="tabs">
		...
		<DIV class="tab_container">
			...
			<tr>
				...
				<td>
				 <input  type="button" value="수정반영"  onClick="fn_modify_goods('${goods.goods_id }','goods_page_total)"/>
				</td>
			...
			<DIV class="tab_content" id="tab5">
				...
				<table>
					<tr>
						...
						<td>
						&nbsp;&nbsp;&nbsp;&nbsp;
						 <input  type="button" value="수정반영"  onClick="fn_modify_goods('${goods.goods_id }','publisher_comment')"/>
						</td>
					</tr>
			</table>
				</P>
				...
				<p>
				 <table>
					 <tr>
						...
						<td>
						&nbsp;&nbsp;&nbsp;&nbsp;
						 <input  type="button" value="수정반영"  onClick="fn_modify_goods('${goods.goods_id }','recommendation')"/>
						</td>
					</tr>
			    </table>
				</p>
	...
	<table>
		<tr>
		  <td align=center colspan=2>
		    ...
		    <input type="hidden" name="command" value="modify_goods_image_page" />
