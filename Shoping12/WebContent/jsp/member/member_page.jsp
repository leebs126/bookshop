...
<c:choose>
	...
	<c:when test="${command=='member_join_page' }">
		<tiles:insertDefinition name="member.member_join_page" />
	</c:when>
	<c:when test="${command=='member_login_page' }">
		<tiles:insertDefinition name="member.member_login_page" />
	</c:when>
	<c:when test="${command=='action_join' }">
		<tiles:insertDefinition name="member.member_login_page" />
	</c:when>
	<c:otherwise>
		<tiles:insertDefinition name="mainLayout" />
